...
- **RapidFuzz validation normalization** — made the optional RapidFuzz matcher normalize case,
  spaces, hyphens, and underscores the same way as the built-in fallback so inputs like
  `LIGHTBLUE`, `LIGHT BLUE`, and `light_blue` consistently resolve to `lightblue`.
...
- **Documentation theme** — switched the compiled Sphinx documentation from the Read the Docs
  theme to the PyData Sphinx Theme.
...
- **Anycubic filament database** — 132 filaments across 10 product lines:
  - PLA Basic (29), PLA+ (20), PLA High Speed (10), PLA Matte (22), PLA Silk (11),
    PLA Galaxy (4), PLA Metal (4), PLA Marble (2), PETG Translucent (8), PETG (22)
  - Multi-color Rainbow variant skipped (4-color entry, no single-hex representation)
  - Total filament count: 913 → **1,045**
